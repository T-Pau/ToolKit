...
FAC .reserve BYTES_FP + 1
FACSIGN = FAC + BYTES_FP
FAC_LAST = FAC + BYTES_FP - 1
FACEXTENSION .reserve 1

ARG .reserve BYTES_FP + 1
ARGSIGN = ARG + BYTES_FP
ARG_LAST = ARG + BYTES_FP - 1
ARGEXTENSION .reserve 1
...
; ----------------------------------------------------------------------------
.private COMPLEMENT_FAC_MANTISSA:
    lda FAC+1
    eor #$FF
    sta FAC+1
    lda FAC+2
...
; ----------------------------------------------------------------------------
.private STORE_FAC_IN_TEMP1_ROUNDED:
    ldx #TEMP1X
    ldy #$00
...
; ----------------------------------------------------------------------------
.public STORE_FAC_AT_YX_ROUNDED:
    jsr ROUND_FAC
    stx INDEX
    sty INDEX+1
    ldy #MANTISSA_BYTES
...
; ----------------------------------------------------------------------------
DECTBL {
		.data	$FA,$0A,$1F,$00	; -100000000
		.data	$00,$98,$96,$80	; 10000000
		.data	$FF,$F0,$BD,$C0	; -1000000
		.data	$00,$01,$86,$A0	; 100000
		.data	$FF,$FF,$D8,$F0	; -10000
		.data $00,$00,$03,$E8	; 1000
		.data	$FF,$FF,$FF,$9C	; -100
		.data $00,$00,$00,$0A	; 10
		.data	$FF,$FF,$FF,$FF	; -1
}
